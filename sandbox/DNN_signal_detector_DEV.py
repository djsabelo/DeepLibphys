...
def calculate_loss_tensor(filename, N_Windows, W, signals_models, signals_info, test_included=False):
    ...
    if not test_included:
        ...
        for model_info in signals_models:
            [x_test, y_test] = load_test_data("GRU_" + model_info.dataset_name + "[64.128.-1.-1.-1]"
...
N_Windows = 150
W = 256
filename = "../data/validation/CONFUSION_DRIVER_ALL_[" + str(N_Windows) + "," + str(W) + "]"

signals_models = db.gsr_models
