...
#for d in signals:
patch1 = mpatches.Patch(color='blue', label='Old f1')
patch2 = mpatches.Patch(color='green', label='Young f1')
patch3 = mpatches.Patch(color='red', label='Old f2')
patch4 = mpatches.Patch(color='y', label='Young f2')
