...
def train_block(signals_train,signals_test, signal2model, signal_indexes=None, n_for_each=16, overlap=0.33,random_training=True,
...
original_signals = loadmat(get_fantasia_full_paths()[0])['val'][0][:30000]
...
sig_model = Signal2Model("GRU_Filter_128", save_directory, signal_dim=256, mini_batch_size=32, window_size=512)
...
predicted = generate_predicted_signal(model, 3000, starting_signal=test_signals, window_seen_by_GRU_size=512)
