...
# Create model
class Autoencoder:
    def __init__(self, n_input=1024, n_hidden_1=32, n_hidden_2=3):
    ...
    def fit(self, x, n_epochs=15, learning_rate=0.001, batch_size=32, display_step=1, save=True, name='1', load=False):
        ...
        # - Add noise to x
        self.layer_1 = tf.layers.conv1d(x, self.n_hidden_1, 16)
        self.layer_2 = tf.layers.conv1d(self.layer_1, self.n_hidden_1, 16) # What to transpose?
        #self.layer_3 =
        #self.layer_4 =
