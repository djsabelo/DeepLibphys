...
n_samples = 90000#00 # number of samples from each subject/person
#n_subjects = 40
window_size = 256
...
img_test = np.reshape(images_test[1],(30,30))
img_ctrl = np.reshape(images_train[300],(30,30))
img_noise = img_test
